...
use crate::desc::{split::VirtqUsedElem, Descriptor};
...
/// use virtio_queue::{desc::{split::Descriptor as SplitDescriptor, Descriptor}, Queue, QueueOwnedT};
...
/// #        };
/// #
/// #        descs.push(Descriptor::from(SplitDescriptor::new((0x1000 * (i + 1)) as u64, 0x1000, flags as u16, i + 1)));
/// #    }
/// #
